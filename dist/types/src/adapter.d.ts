import type { AvatarClearReason, AvatarSessionDescription, AvatarState, CanonicalViseme } from "./events.js";
...
export type AvatarMediaConsumer = {
    start(description: Omit<AvatarSessionDescription, "generation" | "audio"> & {
...
export declare function createAvatarMediaConsumer(session: AvatarSession): AvatarMediaConsumer;
